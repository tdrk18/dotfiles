...
This file contains personal instructions for Codex, specific to this user's preferences and workflow.
...
Each chunk of work should result in one commit. Commit after each logical unit is complete and confirmed.
